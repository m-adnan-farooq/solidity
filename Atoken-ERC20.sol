...
contract AToken is IERC20{
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(sender != address(0), "AT1: transfer from the zero address");
        require(recipient != address(0), "AT1: transfer to the zero address");
        require(_balances[sender] > amount,"AT1: transfer amount exceeds balance");
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        ...
        require(tokenOwner != address(0), "AT1: approve from the zero address");
        require(spender != address(0), "AT1: approve to the zero address");
    ...
    function transferFrom(address tokenOwner, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(_allowance > amount, "AT1: transfer amount exceeds allowance");
